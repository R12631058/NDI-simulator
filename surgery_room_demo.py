...
class InteractiveRaycast:
    def __init__(self):
        ...
        self.USD_FILE_PATH = "C:/Nick/surgery_team/surgery_team/USD/workstation.usd"
    ...
    def _setup_scene(self):
        ...
        self.world.scene.add(
            DynamicCuboid(
                prim_path="/World/cube5",
                name="cube5",
                position=np.array([6, -3, 0.6]),
                scale=np.array([1, 1, 1]),
                color=np.array([1.0, 0.5, 0.5])
            )
        )
        ...
        self.world.scene.add(
            DynamicCuboid(
                prim_path="/World/cube7",
                name="cube7",
                position=np.array([9, -3, 0.6]),
                scale=np.array([1, 1, 1]),
                color=np.array([1.0, 0.5, 0.5])
            )
        )
        ...
        '''
        self.import_usd_model(self.USD_FILE_PATH, np.array([0, 0, 0]))
